...
const QUESTIONS = [
  ...
  { id: 'contact', type: 'text', title: '2. 연락처(전화번호)를 남겨주세요! 📱', placeholder: '예) 010-1234-5678' },
  { id: 'gender', type: 'single', title: '3. 성별을 알려주세요.', options: ['남성', '여성'] },
  { id: 'age', type: 'text', title: '4. 나이를 알려주세요.', placeholder: '예) 20' },
  { id: 'job', type: 'single', title: '5. 현재 하고 있는 일을 알려주세요.', options: ['대학생', '휴학생', '취업준비생', '직장인', '기타'] },
  { id: 'school', type: 'text', title: '6. 소속 학교(또는 직장)를 알려주세요. 🏫', description: '직장인이라면 직장명을 적어주셔도 좋고, 원치 않으시면 비워두셔도 됩니다.', placeholder: '학교명 / 직장명 (선택)' },
  { id: 'major', type: 'text', title: '7. 전공(또는 직무)을 알려주세요. 📚', placeholder: '전공 / 직무 (선택)' },
  { id: 'subway', type: 'text', title: '8. 현재 거주하거나 주로 활동하는 곳과 가까운 지하철역을 알려주세요. 🚇', description: '예) 홍대입구역 / 건대입구역 / 신림역', placeholder: '지하철역 이름' },
  { id: 'reason', type: 'textarea', title: '9. 빵실빵실에 지원하게 된 이유는 무엇인가요? 🥐', description: '부담 없이 편하게 적어주세요!' },
  { id: 'favorite', type: 'multiple', title: '10. 평소 어떤 종류의 빵이나 디저트를 가장 좋아하시나요? 🍰', description: '복수 선택 가능', options: ['베이글', '소금빵', '크루아상·페이스트리', '케이크', '쿠키·구움과자', '도넛', '식사빵·샌드위치', '전통빵·동네빵집 스타일', '신상 디저트라면 일단 먹어보는 편', '딱히 가리지 않아요!', '기타'] },
  { id: 'gem', type: 'textarea', title: '11. 나만 알고 있거나 꼭 한번 가보고 싶은 빵집이 있다면 알려주세요! 🗺️', description: '없다면 최근 맛있게 먹었던 빵이나 디저트도 좋아요. (선택)' },
  { id: 'important', type: 'multiple', max: 2, title: '12. 빵집을 고를 때 가장 중요하게 보는 것은 무엇인가요? 👀', description: '최대 2개 선택', options: ['빵이 맛있는 곳', '유명한 핫플', '숨겨진 동네 빵집', '공간이나 인테리어가 예쁜 곳', '사진이 잘 나오는 곳', '가성비가 좋은 곳', '독특한 메뉴가 있는 곳', '웨이팅이 적고 편하게 갈 수 있는 곳'] },
  { id: 'activities', type: 'multiple', title: '13. 빵실빵실에서 해보고 싶은 활동을 골라주세요! 🧁', description: '복수 선택 가능', options: ['유명 베이커리 핫플 투어', '숨은 동네 빵집 탐방', '빵 여러 개 사서 1/N 빵파티', '신상 디저트 도장깨기', '베이킹·쿠킹 클래스', '빵지순례 코스 짜서 돌아보기', '카페·피크닉 등 번개 모임', '멤버 추천 빵집 방문', '기타'] },
  { id: 'schedule', type: 'matrix', title: '14. 활동 가능한 요일과 시간대를 모두 선택해주세요. 📅', description: '요일별 복수 선택 가능', rows: ['월요일', '화요일', '수요일', '목요일', '금요일', '토요일', '일요일'], cols: ['오전', '오후', '저녁'] },
  { id: 'area', type: 'multiple', title: '15. 서울에서 활동 가능한 지역을 모두 선택해주세요. 📍', description: '복수 선택 가능', options: ['홍대·연남·망원', '문래·영등포', '성수·건대', '안국·종로·혜화', '강남·잠실', '신림·서울대입구', '마곡·발산', '서울이라면 지역 상관없어요!', '기타'] },
  { id: 'atmosphere', type: 'textarea', title: '16. 빵실빵실에서 어떤 분위기의 모임을 기대하시나요? 🤍', description: '예) 편하게 수다 떨 수 있는 분위기 / 빵 맛집을 열심히 찾아다니는 모임 / 소수로 친해지는 분위기 등' },
...
export default function Form() {
  ...
  const [photos, setPhotos] = useState<string[]>([
    ...
    "/images/gallery/media_1788281309050.jpg",
